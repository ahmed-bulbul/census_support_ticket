...
export class Tire2Guard implements CanActivate {
  ...
  canActivate(
    ...
    if(this.login.isLoggedIn() && (authorities != null && (authorities.includes("ROLE_TIRE2_USER")) ||(authorities.includes("ROLE_SUPER_ADMIN")) )){
